...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default=None, help='Checkpoint to load model from')
    ...
    parser.add_argument('--num_samples', type=int, default=64, help='Number of samples for sampling dataset')
    parser.add_argument('--magnitude_ratio', type=float, default=0.1,
                        help='Sparsity ratio for magnitude pruning')
    parser.add_argument('--ci_ratio', type=float, default=0.6,
                        help='Sparsity ratio for concern identification pruning')
    parser.add_argument('--ti_ratio', type=float, default=0.1,
                        help='Recovery ratio for tangling identification')
    parser.add_argument('--include_layers', type=str, nargs='+', default=["attention", "intermediate", "output"],
    ...
    for i in range(num_labels):
        ...
        all_samples = SamplingDataset(
            train_dataloader, 10000, args.num_samples, num_labels, False, 4, device=device
        )
