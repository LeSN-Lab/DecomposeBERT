...
for i in range(num_labels):
    ...
    prune_concern_identification(model, module, positive_samples)
    ...
    save_module(binary_module, model_config.Modules, model_config.model_name + num_labels + datetime.now().strftime("%H:%M:%S"))
