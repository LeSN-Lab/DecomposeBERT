...
# In[]
import os
os.chdir('/home/Minwoo/LESN/Decompose/DecomposeBertintoModules/utils/SDGclassfierBert/model_config/')
model_checkpoint = "./"
model_id = "sadickam/sdg-classification-bert"
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    results = list(tqdm(executor.map(process_row, test_df.itertuples(index=False), chunksize=1), total=len(test_df)))
